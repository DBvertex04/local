...
//     const itemsPerPage = 4; // एक बार में कितनी प्रॉपर्टीज़ दिखानी हैं

//     const nextSlide = () => {
//         if (index < properties.length - itemsPerPage) {
//             setIndex(index + 1);
//         }
//     };
...
//                     {/* Top section: Details (Bina image ke) */}
//                     {/* <div>
//                         <div className="flex items-center gap-2">
...
//                     <h2 className="text-[24px] text-[#121828] font-extrabold">Properties For Sale</h2>
//                     <div className="flex gap-2">
//                         <button className="p-2" onClick={prevSlide} disabled={index === 0}>
//                             <Image src="/left arrow.svg" alt="Previous" width={40} height={40} />
//                         </button>
//                         <button className="p-2" onClick={nextSlide} disabled={index >= properties.length - itemsPerPage}>
...
// Card ke liye SVG Icons (यह कोड जैसा था वैसा ही रहेगा)
...
export default function Details() {
    ...
    const amenities = [
        { name: "Gated Community", icon: <img src="/Container.png" alt="Gated Community" />, special: true },
        { name: "Lift", icon: <img src="/Cycladic home.png" alt="Lift" />, special: false },
        { name: "Swimming Pool", icon: <img src="/Pool.png" alt="Swimming Pool" />, special: true },
        { name: "Parking", icon: <img src="/Frame.png" alt="Parking" />, special: false },
        { name: "Smart Security", icon: <img src="/Frames.png" alt="Smart Security" />, special: false },
        { name: "EV Charging", icon: <img src="/Frameappartment.png" alt="EV Charging" />, special: false },
    ];

    const [saleIndex, setSaleIndex] = useState(0);
    const [rentIndex, setRentIndex] = useState(0);
    const itemsPerPage = 4; // Ek baar mein 4 items dikhayenge

    // "For Sale" section ke liye functions
    const nextSaleSlide = () => {
    ...
    // "For Rent" section ke liye functions
    const nextRentSlide = () => {
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {p.verified && (
                                            ...
                                            <span className="bg-[#F4FAF2] text-[#2CA003] px-2 py-1 rounded-full text-xs font-semibold flex items-center ">       <img
                                                src="/Shieldcheck.png"
                                                alt="Success Icon"
                                                width={20}
                                                height={20}
