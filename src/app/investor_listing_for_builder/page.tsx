...
export default function Inverstor_listing() {
...
<div style={{border:'solid #1C1D1E3D 1px',padding:'16px',backgroundColor:'#ECF3FFBA',borderRadius:'24px',marginTop:'30px'}}>
  {/* Filter Heading */}
  <p className="text-[14px] font-semibold text-[#2450A0] mb-3">
    Filter out for ease
  </p>
...
>
  ...
  <div className="mt-4">
    ...
    <div className="flex gap-2">
      <button className="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-[#2450A01C] text-[#2450A0] border border-[#E5E7EB]">
        With Plot
      </button>
      <button className="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-[#1218280D] text-gray-500 border border-[#E5E7EB]">
        Without Plot
      </button>
    </div>
  </div>
