    ...
    <div className="relative text-gray-900 bg-gray-50 min-h-screen overflow-hidden font-poppins">
      ...
      <main className="pt-[120px] pb-12 flex justify-center relative z-10" style={{ top: "35px" }}>
        <div className="w-full px-4" style={{ maxWidth: "1000px" }}>
          ...
          <h2 className="text-2xl font-bold text-black mt-8" style={{fontWeight:'800'}}>Verify Listing</h2>
          <p className="text-sm text-gray-500 mt-3">
            Fill out the form with your requirements and we’ll connect you with properties that match your needs fast, easy, and reliable.
          </p>
          ...
          {/* Document Dropdown */}
      {/* Document Dropdown */}
<div className="mb-4" ref={wrapperRef} style={{borderRadius:'16px'}}>
      <label className="text-sm font-semibold block mb-2 text-black">
        <span style={{fontSize:'16px',fontWeight:'700',color:'#0A0909'}}>Select Your Document</span> <span className="text-red-500">*</span>
      </label>
      ...
      <span style={{fontSize:'15px',fontWeight:'500',color:'#6e7381'}}>{doc}</span>
          ...
          <div className="mb-6 w-full" >
            <label className="text-sm font-semibold text-black block mb-2">
             <span style={{fontSize:'16px',fontWeight:'700',color:'#0A0909'}}>Upload the Document</span> <span className="text-red-500">*</span>
            </label>

            <div className="flex items-center border border-gray-300 rounded-full overflow-hidden px-4 py-2 bg-white w-full" style={{borderRadius:'16px'}}>
...
<div>
  <label className="text-sm font-semibold text-black block mb-2">
    <span style={{fontSize:'16px',fontWeight:'700',color:'#0A0909'}}>Upload Images</span> <span className="text-red-500">*</span>
  </label>
  ...
  <div className="mt-4">
    <label htmlFor="uploadImages">
      ...
      >
        ...
        >
         <span style={{fontSize:'16px',fontWeight:'800',color:'##2450A0'}}> UPLOAD MORE IMAGES </span>
        </span>
        <input
          type="file"
          id="uploadImages"
        ...
        />
          ...
          >
            ...
            <p>
              <span style={{fontSize:'12px',fontWeight:'600',color:'#2450A0'}}>Once verified, your listing will get a green</span><span style={{fontSize:'12px',fontWeight:'600',color:'#2450A0'}} >‘Verified’</span > tag.
            </p>
          </div>
